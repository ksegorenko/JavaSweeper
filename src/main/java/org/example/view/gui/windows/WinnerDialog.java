...
import org.example.scores.HighScores;
...
public class WinnerDialog extends JDialog{
    public WinnerDialog(GameWindow owner) {
        super(owner, "Game over", true);
        add(new JLabel("<html><h1>Yahhh you are winner! Congratulations!!!</h1>" + "<h3>Now you can save your result<h3></html>"), BorderLayout.CENTER);
